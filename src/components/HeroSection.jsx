...
const imagesArray = [
    { src: "/HeroSection/building-1", alt: "image-1" },
    { src: "/HeroSection/img-2", alt: "image-2" },
    { src: "//HeroSection/Img-3", alt: " image-3 " },
    ...
    <div className="LINKS ">
      ...
      <div className="Footer flex justify-between absolute bottom-20 z-20 w-full px-10">
        ...
        <div className='FooterCenter'>
           <div className='Content relative flex flex-col w-[888px] h-[67px] border border-white'>
            <p className='font-Lato text-[20px] text-white text-center'>5,000,000 GBP</p>
            <div className='absolute bottom-0 flex flex-row gap-x-12 px-4'>
